...
class SocialMedia extends Component {
  state = {
    socials: [
      ...
      { id: 3, name: 'twitter', icon: 'fa fa-twitter fa-lg', url: 'https://twitter.com/Sumercisco' },
      { id: 4, name: 'linkedin', icon: 'fa fa-linkedin-square fa-lg', url: 'https://www.linkedin.com/in/diego-lopez-sarmiento-7330b156/' },
    ]
  }
  render() {
